...
function setup(){
	...
	if( is_page_template( 'template-legacy-splash.php' ) ){
		...
		add_action( 'fuse_content', __NAMESPACE__ . '\load_legacy_splash_wrapper' );
	...
	function load_legacy_splash_wrapper(){

		Controllers\render( 'fragments/zz-legacy/_splash' );
